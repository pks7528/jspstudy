	...
	*/
	...
	/*
	  	4. doGet()
	  		...
	  		2) GET 방식의 요청의 예시
	  			(1) <a href="http://localhost:9090/01_Servlet/HelloServlet">	a링크는 100% get방식,, post방식 사용 불가
	  			(2) <form action="http://localhost:9090/01_Servlet/HelloServlet">	메소드를 생략하면 get방식
